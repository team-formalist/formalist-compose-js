...
function compiler(store, formConfig) {
  ...
  var destinations = {
    ...
    visitField: function visitField(path, definition, index) {
      ...
      var displayVariant = definition.get(_schemaMapping2.default.field.displayVariant);
      var value = definition.get(_schemaMapping2.default.field.value);
      var rules = definition.get(_schemaMapping2.default.field.rules);
    ...
    visitAttr: function visitAttr(path, definition) {
      ...
      var rules = definition.get(_schemaMapping2.default.attr.rules);
    ...
    visitMany: function visitMany(path, definition) {
      ...
      var rules = definition.get(_schemaMapping2.default.many.rules);
      var errors = definition.get(_schemaMapping2.default.many.errors);
      var config = definition.get(_schemaMapping2.default.many.config);
    ...
    visitSection: function visitSection(path, definition) {
      ...
      var config = definition.get(_schemaMapping2.default.section.config);
