  ...
  var destinations = {
    ...
    visitManyChildForms: function visitManyChildForms(_ref7) {
      ...
      var children = contents.map(function (node, index) {
        ...
        return visit.call(_this4, { path: contentsPath, namePath: childNamePath, node: node, index: index });
      });
      ...
      var addChild = function addChild(formName, form) {
        return store.batchDispatch([manyChildFormsActions.addChild(path, formName, form), manyChildFormsActions.validate(path, (0, _formalistValidation2.default)(validationRules))]);
      };
      var removeChild = function removeChild(index) {
        var childPath = contentsPath.push(index);
