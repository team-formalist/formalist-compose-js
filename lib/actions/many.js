...
exports.reorderManyContents = reorderManyContents;
...
function reorderManyContents(path, order) {
  return { type: types.REORDER_MANY_CONTENTS, path: path, order: order };
}

function validateMany(path, validate) {
